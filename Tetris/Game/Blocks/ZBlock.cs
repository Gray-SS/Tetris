...
namespace Tetris.Game.Blocks
{
    public class ZBlock : Block
    {
        ...
        {
            new Vector2[] { new(0, 0), new(1, 0), new(1, 1), new(2, 1) },
            new Vector2[] { new(2, 0), new(2, 1), new(1, 1), new(1, 2) },
            new Vector2[] { new(0, 1), new(1, 1), new(1, 2), new(2, 2) },
            new Vector2[] { new(1, 0), new(1, 1), new(0, 1), new(0, 2) }
        };
