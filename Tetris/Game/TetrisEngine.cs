...
namespace Tetris.Game
{
    public class TetrisEngine : Engine
    {
        ...
        {
            _tetrisViewport = new Rectangle(4, ConsoleHeight / 2 - 12, 10, 22);
        ...
        public override void Draw()
        {
            ...
            if (_gameOver) Graphics.DrawText(_tetrisViewport.Right + 5, 5, $"Game Over !", CColor.Red, null);
        }
        ...
        private void DrawGameGrid(GameGrid gameGrid)
        {
            for(int j = 0; j < gameGrid.Height; j++)
            {
                for (int i = 0; i < gameGrid.Width; i++)
                {
                    ...
                    if (id != 0)
                    {
                        Graphics.DrawRectangle(_tetrisViewport.X + i + 1, _tetrisViewport.Y + j + 1, 1, 1, null, null, (CColor)id);
                    }
                }
            }
        }
